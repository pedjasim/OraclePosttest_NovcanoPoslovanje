CREATE OR REPLACE PACKAGE BODY                    ARHIVIRANJE_ITER_PACKAGE
AS
   ...
   BEGIN
        ...
        LOOP
              ...
              UPIS_U_LOG('I', 'Poditeracija: ' || nPoditeracija, nIteracija);  
              UPIS_U_LOG('I', 'Za brisanje, pre ' || TO_CHAR(nBrojDanaOd) || ' dana', nIteracija);  
              ...
              INSERT INTO ARH_CPM_OBRADA   (ID_CPM_DAN,
                 ...
                 SELECT c.*
                   FROM CPM_OBRADA c
                  WHERE c.DATUM < SYSDATE - nBrojDanaOd;
              ...
              DELETE CPM_OBRADA
               WHERE DATUM < SYSDATE - nBrojDanaOd;
                 
              UPIS_U_LOG('I', 'Obrisano CPM_OBRADA ' || TO_CHAR(SQL%ROWCOUNT), nIteracija);                      
              UPIS_U_LOG('I', 'Kraj poditeracije: ' || nPoditeracija || ' - uraðen commit za period od ' || nPeriod || ' dana', nIteracija);                                     
              UPIS_U_LOG('I', 'Sledi sleep od 30 sekudni', nIteracija);  
              
              COMMIT;  
              
              sys.dbms_lock.sleep (30);
        
              IF nBrojDanaOd - nPeriod < nBrojDanaDo THEN
                  EXIT;
              END IF;     
        
              nBrojDanaOd := nBrojDanaOd - nPeriod;
              nPoditeracija := nPoditeracija + 1;
